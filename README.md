...
Gurux.DLMS library is a high-performance Java component for Android that helps you to read you DLMS/COSEM compatible electricity, gas or water meters. We have try to make component so easy to use that you do not need understand protocol at all.
...
You can report the [issues](https://www.gurux.fi/project/issues/gurux.dlms.Android). 
...
You do not necessary need to use Gurux media component like gurux.net.android or gurux.serial.android 
You can use any connection library you want to.
Gurux.DLMS classes only generate and parse the DLMS data.

You can get [source codes](https://www.github.com/gurux/gurux.dlms.android) or if you use Maven add this to your gradle-file:
```java
implementation("org.gurux:Gurux.Common.Android:2.0.10")

```
Note! Check the [latest version]("https://central.sonatype.com/artifact/org.gurux/gurux.dlms.android").

...
public class GXDLMSClient {
     ...
     * @return Collection of COSEM objects.
     */
    public final GXDLMSObjectCollection parseObjects(final Context context, final GXByteBuffer data, final boolean onlyKnownObjects) {
        return parseObjects(context, data, onlyKnownObjects, true);
    }
    ...
    public final GXDLMSObjectCollection parseObjects(final Context context, final GXByteBuffer data, final boolean onlyKnownObjects,
        ...
        return parseObjects(context, data, onlyKnownObjects, ignoreInactiveObjects, converter);
    }
    ...
    public final GXDLMSObjectCollection parseObjects(final Context context, final GXByteBuffer data, final boolean onlyKnownObjects,
        ...
        if (converter != null) {
            converter.updateOBISCodeInformation(context, objects);
        }
        return objects;
    }
     ...
     */
    public final List<Entry<GXDLMSObject, Integer>> parsePushObjects(final Context context, final List<?> data) {

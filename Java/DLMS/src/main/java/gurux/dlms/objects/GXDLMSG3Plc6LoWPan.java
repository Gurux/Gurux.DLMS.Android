...
public class GXDLMSG3Plc6LoWPan extends GXDLMSObject implements IGXDLMSBase {
    ...
    /**
     * @param value Routing table PIB attribute 0x03.
     */
    ...
    /**
     * @param value Defines the maximum number of hops to be used by the routing
     *              algorithm. PIB attribute 0x0F.
     */
    ...
    /**
     * @param value The weak link value defines the LQI value below which a link
    ...
    /**
     * @param value The minimum security level to be used for incoming and
    ...
    /**
     * @param value Contains the list of prefixes defined on this PAN PIB
     *              attribute 0x01.
     */
    ...
    /**
     * @param value The routing configuration element specifies all parameters
    ...
    /**
     * @param value Maximum time to live of an adpBroadcastLogTable entry (in
     *              minutes). PIB attribute 0x02.
     */
    ...
    /**
     * @param value Contains the context information associated to each CID
    ...
    /**
     * @param value Contains the list of the blacklisted neighbours.Key is 16-bit
    ...
    /**
     * @param value Broadcast log table PIB attribute 0x0B.
     */
    ...
    /**
     * @param value Contains the group addresses to which the device belongs.
    ...
    /**
     * @param value Network join timeout in seconds for LBD PIB attribute 0x20.
     */
    ...
    /**
     * @param value Timeout for path discovery in seconds. PIB attribute 0x21.
     */
    ...
    /**
     * @param value Index of the active GMK to be used for data transmission. PIB
     *              attribute 0x22.
     */
    ...
    /**
     * @param value Metric Type to be used for routing purposes. PIB attribute
     *              0x3.
     */
    ...
    /**
     * @param value Defines the short address of the coordinator. PIB attribute
     *              0x8.
     */
    ...
    /**
     * @param value Is default routing (LOADng) disabled. PIB attribute 0xF0.
     */
    ...
    /**
     * @param value Defines the type of the device connected to the modem PIB
     *              attribute 0x10.
     */
    ...
    /**
     * @param value If true, the default route will be created. PIB attribute
     *              0x24.
     */
    ...
    /**
     * @param value List of the addresses of the devices for which this LOADng
    ...
    /**
     * @param value PIB attribute 0x04.
     */
    ...
    /**
     * @param value PIB attribute 0x05.
     */

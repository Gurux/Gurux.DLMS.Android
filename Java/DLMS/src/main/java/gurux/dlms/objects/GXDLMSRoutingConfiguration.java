...
public class GXDLMSRoutingConfiguration {
    ...
    /**
     * @param value Maximum time that a packet is expected to take to reach any
    ...
    /**
     * @param value Maximum time-to-live of a routing table entry (in minutes).
     *              PIB attribute: 0x12.
     */
    ...
    /**
     * @param value A weight factor for the Robust Mode to calculate link cost.
     *              PIB attribute: 0x13.
     */
    ...
    /**
     * @param value A weight factor for modulation to calculate link cost. PIB
     *              attribute: 0x14.
     */
    ...
    /**
     * @param value A weight factor for number of active tones to calculate link
     *              cost. PIB attribute: 0x15.
     */
    ...
    /**
     * @param value A weight factor for LQI to calculate route cost. PIB
     *              attribute: 0x16.
     */
    ...
    /**
     * @param value A weight factor for hop to calculate link cost. PIB attribute:
     *              0x17.
     */
    ...
    /**
     * @param value A weight factor for the number of active routes in the routing
     *              table to calculate link cost. PIB attribute: 0x1B.
     */
    ...
    /**
     * @param value The number of RREQ retransmission in case of RREP reception
    ...
    /**
     * @param value The number of seconds to wait between two consecutive RREQ –
    ...
    /**
     * @param value Maximum time-to-live of a blacklisted neighbour entry (in
     *              minutes). PIB attribute: 0x1F.
     */
    ...
    /**
     * @param value If TRUE, the RREQ shall be generated with its 'unicast RREQ'.
     *              PIB attribute: 0x0D.
     */
    ...
    /**
     * @param value Enable the sending of RLCREQ frame by the device. PIB
     *              attribute: 0x09.
     */
    ...
    /**
     * @param value It represents an additional cost to take into account a

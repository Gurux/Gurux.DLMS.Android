...
public class GXDLMSFunctionControl extends GXDLMSObject implements IGXDLMSBase {
    ...
    /**
     * @param value The current status of each functional block defined in the
     *              functions property.
     */
    ...
    /**
     * @param value List of modified functions.
     */
     ...
     * @param functions Enabled or disabled functions.

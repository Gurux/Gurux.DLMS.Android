...
public class GXDLMSCoAPSetup extends GXDLMSObject implements IGXDLMSBase {
    ...
    /**
     * @param value TCP-UDP setup object.
     */
    ...
    /**
     * @param value The minimum initial ACK timeout in milliseconds.
     */
    ...
    /**
     * @param value The random factor to apply for randomness of the initial ACK
     *              timeout.
     */
    ...
    /**
     * @param value The maximum number of retransmissions for a confirmable
     *              message.
     */
    ...
    /**
     * @param value The amount of simultaneous outstanding CoAP request messages.
     */
    ...
    /**
     * @param value Delay acknowledge timeout in milliseconds.
     */
    ...
    /**
     * @param value Exponential back off.
     */
    ...
    /**
     * @param value CoAP transport mode.
     */
    ...
    /**
     * @param value The version of the DLMS/COSEM CoAP wrapper.
     */
    ...
    /**
     * @param value The length of the Token.
     */

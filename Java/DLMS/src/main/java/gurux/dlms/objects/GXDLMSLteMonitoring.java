...
public class GXDLMSLteMonitoring extends GXDLMSObject implements IGXDLMSBase {
    ...
    /**
     * @param value Network parameters for the LTE network.
     */
    ...
    /**
     * @param value Quality of service of the LTE network.
     */
    ...
    public final String[] getNames(final Context context) {
        return new String[]{context.getString(R.string.logical_name), "Network parameters", "Quality of service"};
    }

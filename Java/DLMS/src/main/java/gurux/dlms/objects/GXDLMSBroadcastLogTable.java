...
public class GXDLMSBroadcastLogTable {
    ...
    /**
     * @param value Source address of a broadcast packet.
     */
    ...
    /**
     * @param value The sequence number contained in the BC0 header
     */
    ...
    /**
     * @param value Remaining time in minutes until when this entry in the

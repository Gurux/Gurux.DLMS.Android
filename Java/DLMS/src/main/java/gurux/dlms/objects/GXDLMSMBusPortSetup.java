...
public class GXDLMSMBusPortSetup extends GXDLMSObject implements IGXDLMSBase {
    ...
    /**
     * @param value References an M-Bus communication port setup object describing
     *              the physical capabilities for wired or wireless communication.
     */
    ...
    /**
     * @param value Communication status of the M-Bus node.
     */
    ...
    /**
     * @param value M-Bus data header type.
     */
    ...
    /**
     * @param value The primary address of the M-Bus slave device.
     */
    ...
    /**
     * @param value Identification Number element of the data header.
     */
    ...
    /**
     * @param value Manufacturer Identification element.
     */

...
public class GXLteNetworkParameters {
    ...
    /**
     * @param value T3402 timer in seconds.
     */
    ...
    /**
     * @param value T3412 timer in seconds.
     */
    ...
    /**
     * @param value T3412ext2 timer in seconds.
     */
    ...
    /**
     * @param value Power saving mode active timer timer in 0,01 seconds.
     */
    ...
    /**
     * @param value Extended idle mode DRX cycle timer in 0,01 seconds.
     */
    ...
    /**
     * @param value DRX paging time window timer in seconds.
     */
    ...
    /**
     * @param value The minimum required Rx level in the cell in dBm.
     */
    ...
    /**
     * @param value The minimum required Rx level in enhanced coverage CE Mode A.
     */

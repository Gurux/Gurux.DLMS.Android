...
public class GXDLMSArrayManager extends GXDLMSObject implements IGXDLMSBase {
     ...
     * @param client   DLMS client.
     * @param id       Array identified.
     * @param index    One based entry index number.
     * @param entry    Inserted entry.
     * @param dataType The data type of the inserted entry.
     * @return Action bytes.
     * @throws NoSuchPaddingException             No such padding exception.
     * @throws NoSuchAlgorithmException           No such algorithm exception.
     * @throws InvalidAlgorithmParameterException Invalid algorithm parameter exception.
    ...
    public final String[] getNames(final Context context) {
        return new String[]{context.getString(R.string.logical_name), "Objects"};
    }

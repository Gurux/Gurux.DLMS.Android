...
public class GXDLMSMeterPrimaryAccountNumber {
     ...
     */
    private GXUInt64 decoderReferenceNumber;
     ...
     * Decoder reference number.
     */
    public final GXUInt64 getDecoderReferenceNumber() {
     ...
     * Decoder reference number.
     */
    public final void setDecoderReferenceNumber(final GXUInt64 value) {

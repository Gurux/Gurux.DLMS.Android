...
public class GXDLMSPrimeNbOfdmPlcMacFunctionalParameters extends GXDLMSObject implements IGXDLMSBase {
     ...
     */
    public GXDLMSPrimeNbOfdmPlcMacFunctionalParameters(final String ln, final int sn) {
    ...
    /**
     * @param value LNID allocated to this node at time of its registration.
     */
    ...
    /**
     * @param value LSID allocated to this node at the time of its promotion.
     */
    ...
    /**
     * @return SID of the switch node through which this node is connected to the
     * subnetwork.
     */
    ...
    /**
     * @param value SID of the switch node through which this node is connected to
     *              the subnetwork.
     */
    ...
    /**
     * @param value Subnetwork address to which this node is registered.
     */
    ...
    /**
     * @param value Present functional state of the node.
     */
    ...
    /**
     * @param value The SCP length, in symbols, in present frame.
     */
    ...
    /**
     * @param value Level of this node in subnetwork hierarchy.
     */
    ...
    /**
     * @param value Number of beacon slots provisioned in present frame structure.
     */
    ...
    /**
     * @return Beacon slot in which this device’s switch node transmits its beacon.
     */
    ...
    /**
     * @param value Beacon slot in which this device’s switch node transmits its
     *              beacon.
     */
    ...
    /**
     * @param value Beacon slot in which this device transmits its beacon.
     */
    ...
    /**
     * @param value Number of frames between receptions of two successive beacons.
     */
    ...
    /**
     * @param value Number of frames between transmissions of two successive
     *              beacons.
     */
    ...
    public final Object[] getValues() {
        return new Object[]{getLogicalName(), lnId, lsId, sId, sna, state, scpLength, nodeHierarchyLevel,
                beaconSlotCount, beaconRxSlot, beaconTxSlot, beaconRxFrequency, beaconTxFrequency, capabilities};
    }
    ...
    public final void setValue(final GXDLMSSettings settings, final ValueEventArgs e) {
        switch (e.getIndex()) {
            ...
            case 13:
                ...
                break;
            case 14:
                capabilities = MacCapabilities.forValue(((Number) e.getValue()).shortValue());
                break;
            default:
                e.setError(ErrorCode.READ_WRITE_DENIED);
                break;
    ...
    public final void load(final GXXmlReader reader) throws XMLStreamException {
        ...
        capabilities = MacCapabilities.forValue(reader.readElementContentAsInt("Capabilities"));
    }
    ...
    public final void save(final GXXmlWriter writer) throws XMLStreamException {
        ...
        writer.writeElementString("Capabilities", MacCapabilities.toInteger(capabilities));
    }

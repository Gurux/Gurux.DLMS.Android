...
public class GXDLMSG3PlcMacSetup extends GXDLMSObject implements IGXDLMSBase {
    ...
    /**
     * @param value The 16-bit address the device is using to communicate through
    ...
    /**
     * @param value Route cost to coordinator. PIB attribute 0x10F.
     */
    ...
    /**
     * @param value The 16-bit identifier of the PAN through which the device is
     *              operating. PIB attribute 0x50.
     */
    ...
    /**
     * @param value This attribute holds GMK keys required for MAC layer
    ...
    /**
     * @param value The outgoing frame counter for this device, used when
    ...
    /**
     * @param value Defines the tone mask to use during symbol formation. PIB
     *              attribute 0x110.
     */
    ...
    /**
     * @param value Maximum time to live of tone map parameters entry in the
     *              neighbour table in minutes. PIB attribute 0x10D.
     */
    ...
    /**
     * @param value Maximum number of retransmissions. PIB attribute 0x59.
     */
    ...
    /**
     * @param value Maximum time to live for an entry in the neighbour table in
     *              minutes PIB attribute 0x10E.
     */
    ...
    /**
     * @param value The neighbour table contains information about all the devices
     *              within the POS of the device PIB attribute 0x010A.
     */
    ...
    /**
     * @param value The high priority contention window size in number of slots.
    ...
    /**
     * @param value Channel access fairness limit. PIB attribute 0x10C.
     */
    ...
    /**
     * @param value Duration time in seconds for the beacon randomization. PIB
     *              attribute 0x111.
     */
    ...
    /**
     * @param value This parameter controls the adaptive CW linear decrease. PIB
     *              attribute 0x0112.
     */
    ...
    /**
     * @param value Rate adaptation factor for channel access fairness limit. PIB
     *              attribute 0x113.
     */
    ...
    /**
     * @param value Number of consecutive attempts while using minimum CW. PIB
     *              attribute 0x114.
     */
    ...
    /**
     * @param value This read only attribute indicates the capability of the node.
     *              PIB attribute 0x115.
     */
    ...
    /**
     * @param value Maximum value of backoff exponent. PIB attribute 0x47.
     */
    ...
    /**
     * @param value Maximum number of backoff attempts. PIB attribute 0x4E.
     */
    ...
    /**
     * @param value Minimum value of backoff exponent. PIB attribute 0x4F.
     */
    ...
    /**
     * @param value If true, MAC uses maximum contention window.
     */
    ...
    /**
     * @param value Attenuation of the output level in dB.
     */
    ...
    /**
     * @param value The neighbour table contains some information about all the
     *              devices within the POS of the device.
     */
    ...
    /**
     * @param value Duplicate frame detection time in seconds.
     */
     ...
     * @param address MAC short address

...
public class GXDLMSDemandRegister extends GXDLMSObject implements IGXDLMSBase {
    ...
    public final void load(final GXXmlReader reader) throws XMLStreamException {
        currentAverageValue =
                reader.readElementContentAsObject("CurrentAverageValue", null, this, 2);
    ...
    public String[] getNames(final Context context) {
        return new String[]{context.getString(R.string.logical_name), "Current Average Value", "Last Average Value",

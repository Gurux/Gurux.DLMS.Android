...
public class GXDLMSG3PlcMacLayerCounters extends GXDLMSObject implements IGXDLMSBase {
    ...
    /**
     * @param value Statistic counter of successfully transmitted data packets.
    ...
    /**
     * @param value Statistic counter of successfully received data packets. PIB
     *              attribute: 0x0102.
     */
    ...
    /**
     * @param value Statistic counter of successfully transmitted command packets.
     *              PIB attribute: 0x0103.
     */
    ...
    /**
     * @param value Statistic counter of successfully received command packets.
    ...
    /**
     * @param value Counts the number of times when CSMA backoffs reach
     *              macMaxCSMABackoffs. PIB attribute: 0x0105.
     */
    ...
    /**
     * @param value Counts the number of times when an ACK is not received while
     *              transmitting a unicast data frame. PIB attribute: 0x0106.
     */
    ...
    /**
     * @param value Statistic counter of the number of frames received with bad
    ...
    /**
     * @param value Statistic counter of the number of broadcast frames sent. PIB
     *              attribute: 0x0108.
     */
    ...
    /**
     * @param value Statistic counter of successfully received broadcast packets

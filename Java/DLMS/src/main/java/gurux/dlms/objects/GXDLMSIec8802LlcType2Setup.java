...
public class GXDLMSIec8802LlcType2Setup extends GXDLMSObject implements IGXDLMSBase {
    ...
    /**
     * @param value Transmit Window Size K.
     */
    ...
    /**
     * @param value Transmit Window Size RW.
     */
    ...
    /**
     * @param value Maximum octets in I Pdu N1.
     */
    ...
    /**
     * @param value Maximum number of transmissions, N2.
     */
    ...
    /**
     * @param value Acknowledgement timer in seconds.
     */
    ...
    /**
     * @param value P-bit timer in seconds.
     */
    ...
    public final Object[] getValues() {
        return new Object[]{getLogicalName(), transmitWindowSizeK, transmitWindowSizeRW, maximumOctetsPdu,
                maximumNumberTransmissions, acknowledgementTimer, bitTimer, rejectTimer, busyStateTimer};
    }
    ...
    public final void load(final GXXmlReader reader) throws XMLStreamException {
        ...
        acknowledgementTimer = reader.readElementContentAsInt("AcknowledgementTimer");
    ...
    public String[] getNames(final Context context) {
        return new String[]{context.getString(R.string.logical_name), "TransmitWindowSizeK", "TransmitWindowSizeRW", "MaximumOctetsPdu",
                "MaximumNumberTransmissions", "AcknowledgementTimer", "BitTimer", "RejectTimer", "BusyStateTimer"};
    }

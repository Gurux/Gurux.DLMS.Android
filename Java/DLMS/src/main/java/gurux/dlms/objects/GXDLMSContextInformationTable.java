...
public class GXDLMSContextInformationTable {
    ...
    /**
     * @param value Corresponds to the 4-bit context information used for source
    ...
    /**
     * @param value Indicates if the context is valid for use in compression.
     */
    ...
    /**
     * @param value Remaining time in minutes during which the context information
     *              table is considered valid. It is updated upon reception of the
     *              advertised context.
     */

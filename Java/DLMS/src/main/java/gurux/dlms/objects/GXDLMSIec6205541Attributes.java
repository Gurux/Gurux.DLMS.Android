...
public class GXDLMSIec6205541Attributes extends GXDLMSObject implements IGXDLMSBase {
    ...
    /**
     * @param value Encryption algorithm.
     */
    ...
    /**
     * @param value Meter primary account number.
     */
    ...
    /**
     * @param value Meter commodity. This can be ELECTRICITY, WATER, GAS, or TIME.
     */
    ...
    /**
     * @param value Token carrier types.
     */
    ...
    /**
     * @param value Key revision number.
     */
    ...
    /**
     * @param value Number of key change tokens supported by the serve.
     */
    ...
    /**
     * @param value Conformance certificate number.
     */
        ...
        switch (e.getIndex()) {
            ...
            case 2:
                if (e.getValue() instanceof GXStructure) {
                    ...
                    meterPan.setDecoderReferenceNumber(((GXUInt64) s.get(1)));
    ...
    public final void load(GXXmlReader reader) throws XMLStreamException {
        ...
        if (str != null && str != "") {
            meterPan.setDecoderReferenceNumber(new GXUInt64(new BigInteger(str)));
        }

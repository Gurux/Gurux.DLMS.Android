...
public class GXDLMSRoutingTable {
    ...
    /**
     * @param value Address of the destination.
     */
    ...
    /**
     * @param value Address of the next hop on the route towards the destination.
     */
    ...
    /**
     * @param value Cumulative link cost along the route towards the destination.
     */
    ...
    /**
     * @param value Number of hops of the selected route to the destination.
     */
    ...
    /**
     * @param value Number of weak links to destination.
     */
    ...
    /**
     * @param value Remaining time in minutes until when this entry in the routing
     *              table is considered valid.
     */

...
public class GXPlcSettings {
    ...
    /**
     * @param value Initial credit (IC) tells how many times the frame must be
     *              repeated. Maximum value is 7.
     */
    ...
    /**
     * @param value The current credit (CC) initial value equal to IC and
    ...
    /**
     * @param value Delta credit (DC) value.
     */
    ...
    /**
     * @param value IEC 61334-4-32 LLC uses 6 bytes long system title. IEC
    ...
    /**
     * @param value Source MAC address.
     */
    ...
    /**
     * @param value Destination MAC address.
     */
    ...
    /**
     * @param value Response probability.
     */
    ...
    /**
     * @param value Allowed time slots.
     */
    ...
    /**
     * @param value Server saves client system title.
     */
     ...
     * @param newMeter    Is this a new meter.
     * @return Generated bytes.
     */
     ...
     * Register PLC meters.
     *
     * @param initiatorSystemTitle Active initiator system title
     * @param systemTitle          System title.
     * @return Generated bytes.
     */
